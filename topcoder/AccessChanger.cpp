...
namespace moj_harness {
	...
	int run_test_case(int casenum__) {
		switch (casenum__) {
		case 0: {
			string program[]          = {"Test* t = new Test();", 
 "t->a = 1;", 
 "t->b = 2;", 
 "t->go(); // a=1, b=2 --> a=2, b=3"};
			string expected__[]       = {"Test* t = new Test();", "t.a = 1;", "t.b = 2;", "t.go(); // a=1, b=2 --> a=2, b=3" };

			std::clock_t start__      = std::clock();
			vector <string> received__ = AccessChanger().convert(vector <string>(program, program + (sizeof program / sizeof program[0])));
 ...
 "---",
 "> // the parted arrow"};
			string expected__[]       = {"--. // the arrow --->", "---", "> // the parted arrow" };
		...
		case 2: {
			string program[]          = {"->-> // two successive arrows ->->"};
			string expected__[]       = {".. // two successive arrows ->->" };
